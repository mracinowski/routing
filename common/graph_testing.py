...
class DijkstraTestCase(unittest.TestCase):
    edges: dict[str, list[graph.Edge]] = {
        "v1": [graph.Edge("v1", "v2", "e1", 2), graph.Edge("v1", "v3", "e2", 4)],
        "v2": [graph.Edge("v2", "v1", "e1", 2), graph.Edge("v2", "v3", "e3", 1)],
        "v3": [graph.Edge("v3", "v1", "e2", 4), graph.Edge("v3", "v2", "e3", 1)],
    }
    edges2: dict[str, list[graph.Edge]] = {
        "v1": [graph.Edge("v1", "v2", "e1", 2), graph.Edge("v1", "v3", "e2", 1)],
        "v2": [graph.Edge("v2", "v1", "e1", 2), graph.Edge("v2", "v3", "e3", 1)],
        "v3": [graph.Edge("v3", "v1", "e2", 1), graph.Edge("v3", "v2", "e3", 1)],
    }
